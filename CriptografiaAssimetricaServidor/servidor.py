...
class Ponte(threading.Thread):
    ...
    def send_file(self, file_name):
        file_path = os.path.join("C:/Users/edson/OneDrive/Documentos/CriptografiaAssimetricaServidor/", file_name)  # Substitua pelo caminho real do diretório no servidor
